...
from app.models.project import AspectRatio, ContentType, ProjectTone, VideoMode
...
class StoryboardDraft(StrictSchema):
    scenes: list[StoryboardSceneDraft] = Field(min_length=4, max_length=4)

    @model_validator(mode="after")
    def validate_positions(self) -> "StoryboardDraft":
